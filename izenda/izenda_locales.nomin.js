...
!function () {
    ...
    localizer.registerLanguage({
        ...
        REPORTDESIGNER_FILTER_FIELDS_TYPE_VALIDATE: 'Only “AND” conditions can be used in case Filters section contains both aggregated and non- aggregated fields. The current filter logic will be removed.',
        REPORTDESIGNER_FILTER_FIELDS_TYPE_VALIDATE_INFO: 'Any subreports which are inheriting filters will automatically use “AND” conditions between filters',
        REPORTDESIGNER_FILTER_LOGIC_REPORT: 'Filter logic in this report was altered to use “AND” conditions only',
        REPORTDESIGNER_FILTER_LOGIC_SUBREPORT: 'Filter logic in the embedded subreport was altered to use “AND” conditions only',
        // CROSS FILTERING
        ...
        CONNECTION_CAN_NOT_MOVE_CUSTOM_VIEW: 'There is a data source which has same name or alias with this data source, so you cannot move it to Visible Data Sources box.',
        ...
        QUERY_SOURCE_TYPE_CONFIG_MESSAGE_DELETE_CUSTOM_VIEW: 'Are you sure you want to delete this view? Any reports/templates which are using this view will no longer be valid.',
        ...
        DATA_MODEL_LABEL_ADD_CUSTOM_VIEW_SAVE_SUCCESSFUL_MESSAGE: 'The hidden filters if set in configuration file would be added to this view based on the returned field name',
